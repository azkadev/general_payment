...
import 'package:general_payment/package/xendit/schemes/api_schemes.dart';
...
void main(List<String> args) async {
  ...
  Process.runSync("dart", ["format", directory_respond_scheme.path]);
  Process.runSync("dart", ["format", directory_api_scheme.path]);
}
