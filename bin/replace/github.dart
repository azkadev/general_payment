...
git init
git branch -M main
git remote add origin https://github.com/{main_username_owner}/general_payment
git remote set-url --push origin https://{main_username_owner}:{main_github_token}@github.com/{main_username_owner}/general_payment
